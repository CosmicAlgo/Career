...
def get_model():
    ...
    if _model is None:
        try:
            ...
            logger.info("[Embedder] Loading sentence-transformers model (all-MiniLM-L6-v2)...")
...
def extract_skills_from_text(text: str) -> List[str]:
    ...
    skill_keywords = [
        ...
        "python", "javascript", "typescript", "java", "scala", "go", "rust", "c++", "c#",
        "ruby", "php", "swift", "kotlin", "r", "matlab",
        # Web/Frameworks
        "react", "vue", "angular", "node.js", "django", "flask", "fastapi", "spring",
        "rails", "laravel", "next.js", "svelte",
        # Data/ML
        "tensorflow", "pytorch", "scikit-learn", "pandas", "numpy", "jupyter",
        "spark", "kafka", "airflow", "mlflow", "huggingface", "transformers",
        ...
        "ansible", "jenkins", "gitlab ci", "github actions", "cicd", "ci/cd",
        "prometheus", "grafana", "elk", "logging", "monitoring",
        # Databases
        "postgresql", "mysql", "mongodb", "redis", "elasticsearch", "cassandra",
        "dynamodb", "bigquery", "snowflake", "sql", "nosql",
        # Infrastructure
        "linux", "nginx", "apache", "microservices", "serverless", "lambda",
        "ec2", "s3", "eks", "gke", "aks",
        # Other
        "git", "agile", "scrum", "jira", "confluence", "api design", "rest",
        "graphql", "grpc", "protobuf", "swagger", "openapi"
    ]
